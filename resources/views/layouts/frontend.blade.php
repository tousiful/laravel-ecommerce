...
<head lang="en">
    ...
    <link href="{{ asset('//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css') }}" rel='stylesheet' type='text/css'>
...
<header class="header" id="site-header">
    ...
    <div class="container">
        ...
        <div class="header-content-wrapper">
            ...
            <ul class="nav-add">
                <li class="custom_style"><a href="/">Home</a></li>
                <li class="custom_style"><a href="/login">Login</a></li>
                <li class="cart">
        ...
        <div class="row pt120">
            <div class="col-lg-8 col-lg-offset-2">
                <div class="heading align-center mb60">
                    <h4 class="h1 heading-title">Book Shop</h4>
